    ...
    <div class="container">
                    ...
                    <div class="row border-bottom p-3">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 text-center text-sm-right">
                            <select name="delivery" class="form-control">
                                ...
                                <option value="need_delivery" data-cost="7">I need delivery (+$7)</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2">
                ...
                <form class="needs-validation" action="{{ route('cart.confirm') }}">
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="address" name="address" disabled="disabled" autocomplete="off">
                        <div class="invalid-feedback">
